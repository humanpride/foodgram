    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('user', 'recipe'), name='unique_shopping_cart_item')],
            },
        ),
        migrations.CreateModel(
            name='Subscription',
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('from_user', 'to_user'), name='unique_subscription')],
            },
        ),
    ]
