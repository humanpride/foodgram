...
class Command(BaseCommand):
    help = (
        'Import tags from a CSV or JSON file. '
        'Usage: python manage.py import_tags /path/to/file'
    )
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            help=(
                ...
                'Expected columns: name, slug (header optional).'
            ),
        )
    ...
    def handle(self, *args, **options):
        try:
            ...
            created = Tag.objects.bulk_create(tags, ignore_conflicts=True)
